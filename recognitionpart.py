# -*- coding: utf-8 -*-
"""recognitionPart.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1L3Ed22VnG9bjGE8ioMsYRw93PpeSKhE1
"""
...
def show_images(images,titles=None):
    ...
    for image,title in zip(images,titles):
        ...
        a.set_title(title)
        n += 1
    fig.set_size_inches(np.array(fig.get_size_inches()) * n_ims) # type: ignore
    plt.show()
...
img = cv.imread('Arabic letters/letters/tah/tah.jpg',0)
...
class character:
    def __init__(self, char, template):
        self.char = char
        self.template = cv.imread(template,cv.IMREAD_GRAYSCALE)
...
Alf2 = character("alf", 'Final_All_pgm_charachters_inNumbersSequence/alf5.png')
...
Non2 = character("non", 'Final_All_pgm_charachters_inNumbersSequence/non5.png')
...
Lam2 = character("lam", 'Final_All_pgm_charachters_inNumbersSequence/lam.png')
...
Dal2 = character("dal", 'Final_All_pgm_charachters_inNumbersSequence/dal4.jpg')
Reh = character("reh", 'Final_All_pgm_charachters_inNumbersSequence/35.jpg')
Reh2 = character("reh", 'Final_All_pgm_charachters_inNumbersSequence/reh5.png')
Kaf = character("kaf", 'Final_All_pgm_charachters_inNumbersSequence/86.jpg')
Kaf2 = character("kaf", 'Final_All_pgm_charachters_inNumbersSequence/88.jpg')
...
Waw2 = character("waw", 'Final_All_pgm_charachters_inNumbersSequence/waw2.jpg')
...
Heh2 = character("heh", 'Final_All_pgm_charachters_inNumbersSequence/heh3.png')
Heh3 = character("heh", 'Final_All_pgm_charachters_inNumbersSequence/heh4.png')
Fih = character("Fih", 'Final_All_pgm_charachters_inNumbersSequence/fih3.png')
Fih2 = character("Fih", 'Final_All_pgm_charachters_inNumbersSequence/fih2.jpg')
Yeh = character("yeh", 'Final_All_pgm_charachters_inNumbersSequence/yeh.jpg')
...
# end of the code that show jimjimOut Folder
# "NOTE" PLEASE TRACE CODE AND FOLDER PATH TO RUN THE CODE 